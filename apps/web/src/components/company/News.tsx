...
const newsItems: NewsItem[] = [
  {
    title: 'AHUNUNU Logistics Expands International Network',
    date: '2024-02-15',
    category: 'Company News',
    summary: 'AHUNUNU Logistics announces expansion of its international shipping network to 20 new countries, enhancing global delivery capabilities.',
  ...
  },
  {
    ...
    date: '2024-01-30',
    category: 'Awards',
    summary: 'AHUNUNU Logistics recognized as the leading logistics provider for excellence in service quality and customer satisfaction.',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p className="text-xl text-gray-600">
              Stay updated with the latest news, achievements, and developments at AHUNUNU Logistics.
            </p>
          </div>
          ...
          <div className="mt-12 bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-gray-600 mb-6">
              For press inquiries, interview requests, or additional information about AHUNUNU Logistics,
