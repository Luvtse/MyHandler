...
class EmailService {
    ...
    async logEmail(userId, type, recipient, subject, status, error) {
        try {
    ...
    // ─── Templates ──────────────────────────────────────────────────────────────
    getEmailTemplate(type, data, userName) {
        const templates = {
            // ── Shipment created ────────────────────────────────────────────────────
            SHIPMENT_CREATED: {
                ...
                html: wrap('Shipment Created', `<p style="font-family:Inter,Arial,sans-serif;color:#0F172A;margin:0 0 16px;">Hi <strong>${userName}</strong>,</p>
          ...
          <p style="font-family:Inter,Arial,sans-serif;color:#94A3B8;font-size:12px;margin-top:24px;">Questions? Reply to this email or visit our <a href="${FRONTEND_URL}/support" style="color:${BRAND_BLUE};">Support Centre</a>.</p>`),
            ...
            SHIPMENT_DELIVERED: {
                ...
                html: wrap('Shipment Delivered', `<p style="font-family:Inter,Arial,sans-serif;color:#0F172A;margin:0 0 16px;">Hi <strong>${userName}</strong>,</p>
          ...
          ${cta('View Shipment Details', `${FRONTEND_URL}/tracking?awb=${data.reference}`)}`),
            ...
            LEAVE_REQUEST: {
                ...
                html: wrap('New Leave Request', `<p style="font-family:Inter,Arial,sans-serif;color:#0F172A;">Hi <strong>${userName}</strong>,</p>
          ...
          ${cta('Review Request', `${FRONTEND_URL}/leave`)}`),
            ...
            PAYOUT_REQUEST: {
                ...
                html: wrap('New Payout Request', `<p style="font-family:Inter,Arial,sans-serif;color:#0F172A;">Hi <strong>${userName}</strong>,</p>
          ...
          ${cta('Review Payout', `${FRONTEND_URL}/finance/payout-requests`)}`),
            ...
            PAYOUT_STATUS: {
                ...
                html: wrap(`Payout ${data.status}`, `<p style="font-family:Inter,Arial,sans-serif;color:#0F172A;">Hi <strong>${userName}</strong>,</p>
