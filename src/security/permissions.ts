export type UserRole = 'customer' | 'driver' | 'admin' | 'warehouse' | 'finance' | 'report' | 'hr_manager' | 'hr_staff' | 'service_point_agent' | 'operations' | 'fleet_manager' | 'account_manager' | 'coo' | 'cfo';
